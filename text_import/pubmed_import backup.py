...
# okay, this will change a lot. it will not be a class anymore, but just a function that will return an Article object
...
def Pubmed_import(pmid, pubmed_email=None, dump_directory_absolute=None, options=None, args=None):
	...
	if dump_directory_absolute:
		helpers.make_directory(dump_directory_absolute)
